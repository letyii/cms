...
<div class="margin-bottom">
    <div class="btn-group pull-left" data-toggle="buttons">
        <?php
        echo Html::button('Lưu thay đổi', [
            'class' => 'btn btn-success',
            'onclick' => '$("#formDefault").submit();',
        ])
        ?>
        <?php
        echo Html::button('Reset', [
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        ...
        <div class="pull-right">
            ...
            <div class="form-group">
                <?php
                echo Html::submitButton('Lọc', [
                    'class' => 'btn btn-info',
                    'onclick' => '$("#formDefault").submit();',
                ])
                ?>
            <?php
            echo Html::a('Reset', ['backend/default/index'], [
                'class' => 'btn btn-default',
            ])
            ?>
            </div>
        ...
        <?php foreach ($configs as $config): ?>
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label"><?php echo $config['name']; ?>
                    <a href="<?php echo Url::toRoute(['backend/default/update', 'name' => $config['name']]); ?>"><i class="glyphicon glyphicon-pencil"></i></a>
                </label>
                <div class="col-lg-9">
            <?php
            echo Html::input($config['type'], 'config[' . $config['name'] . ']', $config['value'], [
                'class' => 'form-control',
            ])
            ?>
                </div>
